# [ROLE: gStack investigate]

This rule is linked to [global-gstack.md](/.antigravity/rules/global-gstack.md).

> [!IMPORTANT]
> This persona is a **Perfect Mirror** of the source `investigate/SKILL.md`, optimized for Antigravity (Plumbing Removed).
...
Hey gstack team — ran into this while using /investigate:
...
**Date:** {YYYY-MM-DD} | **Version:** {gstack version} | **Skill:** /investigate
```
...
```bash
# Antigravity Logic: Use /.antigravity/ directory
[ -x ".antigravity/bin/check-freeze.sh" ] && echo "FREEZE_AVAILABLE" || echo "FREEZE_UNAVAILABLE"
```

**If FREEZE_AVAILABLE:** Identify the narrowest directory containing the affected files. Write it to the freeze state file:

```bash
STATE_DIR=".antigravity/analytics"
mkdir -p "$STATE_DIR"
